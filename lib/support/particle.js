...
{
    // TODO: more nullchecking etc.
    if(typeof settings.p == 'string')
    {
        settings.p = Util.getNestedProperty(ig.global.data.particles, settings.p, null);
    }
    var count = getRangedValue(settings.p.n, false, true);
