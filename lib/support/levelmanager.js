...
LevelManager.prototype.updateExitInfo = function(x, y, vx, vy)
{
    this.relativeExitOffset.x = x;
    this.relativeExitOffset.y = y;
    this.exitVelocity.x = vx;
    this.exitVelocity.y = vy;
}
