...
({
    ...
    init: function( x, y, settings )
    {
        ...
        if(this.thing != null)
        {
            ...
            if(!ig.global.wm)
            {
                this.animStates[DOOR_STATE.CLOSED] = Util.getProperty(this.thing.ao.a[ANIM_STATE_NAMES[DOOR_STATE.CLOSED]], null);
                this.animStates[DOOR_STATE.OPEN] = Util.getProperty(this.thing.ao.a[ANIM_STATE_NAMES[DOOR_STATE.OPEN]], null);
                this.animStates[DOOR_STATE.LOCKED] = Util.getProperty(this.thing.ao.a[ANIM_STATE_NAMES[DOOR_STATE.LOCKED]], null);
    ...
    updateAnimationState: function()
    {
        ...
        var anim = this.animStates[flag];
        if(Util.defined(anim) && anim != null)
        {
            Util.setAnimationState(this, anim, ANIM_STATE_NAMES[flag]);
