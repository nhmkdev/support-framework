/*
 ...
 usex
    1 (one) indicates to use the x position from the last level exited (default: 0)

 usey
    1 (one) indicates to use the y position from the last level exited (default: 0)

 usevel
    1 (one) indicates to use the velocity from the last level exited facing (default: 0)
