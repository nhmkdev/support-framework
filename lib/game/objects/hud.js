...
function HUD()
{
    ...
    this.bgimg = Util.loadImage('hudbg');
...
HUD.prototype.draw = function()
{
    ...
    // TODO: box and "Points" text should be in a static location, not centering
    this.bgimg.draw(this.pointsLocation.x - 48, this.pointsLocation.y - 6);
