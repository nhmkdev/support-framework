...
({
    ...
    init: function()
	{
        ...
        Save.defaultFlag('i', 'dc', 1); // TODO: consider a temp flag for this just in case! (could save with controls disabled...)
    ...
    spawnPlayer: function()
    {
        ...
        if(spawnPoint != null)
        {
            ...
            // destroy all the spawn entities (they are not needed any further)
